...
<script>
    ...
    const pyEventClosedHandle = (e) => {
        // running=false; 
        pyProcesses = difference(pyProcesses, [e.detail.py]);
    ...
    let boltzmanWindow, openBoltzmanWindow = false;
</script>

<BoltzmanDistribution {...boltzmanArgs} maximize={false}
    bind:active={openBoltzmanWindow} bind:graphWindow={boltzmanWindow} 
/>
            ...
            <div class="sub_container__div box">
                ...
                <div class="content__div ">
                    ...
                    <div class="align h-center">
                        <CustomSelect options={energyLevels.map(f=>f.label)} bind:picked={excitedFrom} label="excitedFrom" style="min-width: 7em;" on:change={updateEnergyLevels}/>
                        <CustomSelect options={energyLevels.map(f=>f.label)} bind:picked={excitedTo} label="excitedTo" style="min-width: 7em;" on:change={updateEnergyLevels}/>
