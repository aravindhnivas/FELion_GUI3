...
def fit_all_peaks(filename, norm_method, prominence=None, width=None, height=None,  fullfiles=None):
...
if __name__ == "__main__":
    ...
    fullfiles = [pt(i).stem for i in args[6:]]
    
    fit_all_peaks(filename, norm_method, prominence, width, height, fullfiles)