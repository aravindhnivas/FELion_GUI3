...
while runprogram == 1:
    ...
    if UserChoice == 1:
        ...
        try:
            ...
            print("Zugehoeriges Parameterfile existiert nicht.")
        # Erzeuge Variablen aus 1der Variablenliste und weise Werte aus der Parameterdatei zu

        ListofParameters = ("Temperature", "Timesteps", "NumberOfMasses", "SimulationTime", "StartTimeStep", "n_He", "k01", "k12", "k23", "k10", "k21", "k32", "k34", "k43")
