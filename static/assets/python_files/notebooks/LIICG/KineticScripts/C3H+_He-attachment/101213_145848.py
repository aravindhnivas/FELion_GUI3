...
file = 'C:/Python27/Programs/C3H+_He-attachment/20131210_145848_timescan.txt'
f = open(file, 'r')
...
#k45= 0.0e-31
#k56= 3.5e-31
k10= 2.9e-14     #k10 etc. bin�re Fragmentierung cm�/s; COHe+ + He --> CO+ + 2*He
k21= 1.7e-14 
#k32= 1.0e-14  
#k43= 0.0e-15
#k10_2=2.4e-12 
...
plt.plot(C3H,'r')
plt.plot(data[ : ,0]-5,data[ : ,1], 'ro')
plt.text(150, 2200, '$C_3H^+$', {'color' : 'r', 'fontsize' : 12, 'family' : 'arial'})
plt.plot(C3HHe,'b')
plt.plot(data[ : ,0]-5,data[ : ,2], 'bo')
plt.text(150, 1000, '$He-C_3H^+$', {'color' : 'b', 'fontsize' : 12, 'family' : 'arial'})
plt.plot(HC3H,'g')
#plt.plot(data[ : ,0]-10,data[ : ,2], 'go')
plt.text(150, 5, '$C_3H_2^+$', {'color' : 'g', 'fontsize' : 12, 'family' : 'arial'})
plt.plot(H2C3H,'m')
#plt.plot(data[ : ,0]-10,data[ : ,3], 'mo')
plt.text(150, 30, '$C_3H_3^+$', {'color' : 'm', 'fontsize' : 12, 'family' : 'arial'})
#plt.plot(HCOHe4,'y')
...
plt.plot(summe,'k')
plt.plot(data[ : ,0]-5,summe_meas, 'ko')
plt.text(150, 1800, '$sum$', {'color' : 'k', 'fontsize' : 12, 'family' : 'arial'})
#plt.plot(COHe6,'r')
#plt.plot(data[ : ,0]-100,data[ : ,7], 'ro')
#plt.plot(data[ : ,0]-100,data[ : ,7], 'co')
#plt.text(500,0.15, "k01=%f" %(k01))
plt.text(100,0.2, 'k01= %.2e' %(k01), {'color' : 'k', 'fontsize':10, 'family': 'arial'})
plt.text(100,0.15, 'k10= %.2e, k_H2_1=%.2e, k_H2_2=%.2e' %(k10, kH2_1, kH2_2), {'color' : 'k', 'fontsize':10, 'family': 'arial'})
plt.text(100,0.3, 'nHe=%.2e, T=%.1fK' %(He_0, T_Trap ), {'color' : 'k', 'fontsize':10, 'family': 'arial'})
