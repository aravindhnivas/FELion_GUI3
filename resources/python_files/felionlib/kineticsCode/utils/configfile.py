...
ratek3: list[float] = None
ratekCID: list[float] = None
...
def read_config(
    fit_config_file: pt,
    selectedFile: str,
    k3Guess: list[float, float],
    kCIDGuess: list[float, float],
    k3Labels: list[str],
    kCIDLabels: list[str],
) -> None:
    ...
    ratek3 = [k3Guess[1] / 2 for _ in k3Labels]
    ratekCID = [kCIDGuess[1] / 2 for _ in kCIDLabels]
