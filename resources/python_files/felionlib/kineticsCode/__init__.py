...
def KineticMain():
    ...
    global initialValues, tspan, simulateTime,\
        ...
        numberDensityWidget, saveButton, checkbox, button, \
    ...
    numberDensityWidget, saveButton, checkbox,\
        button, k3Sliders, kCIDSliders, toggleLine = plot_exp(
            compute_attachment_process, widget, k3Labels, kCIDLabels, ratek3,
            ratekCID, kvalueLimits, keyFoundForRate, update, expPlot, fitPlot, args,
            fitfunc, k_fit, k_err, rateCoefficientArgs, plotted, rateConstantsFileData
        )
